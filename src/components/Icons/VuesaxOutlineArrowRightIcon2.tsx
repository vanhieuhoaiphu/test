...
const VuesaxOutlineArrowRightIcon2 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(VuesaxOutlineArrowRightIcon2);
export { Memo as VuesaxOutlineArrowRightIcon2 };
