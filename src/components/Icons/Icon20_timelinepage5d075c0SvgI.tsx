...
const Icon20_timelinepage5d075c0SvgI = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(Icon20_timelinepage5d075c0SvgI);
export { Memo as Icon20_timelinepage5d075c0SvgI };
